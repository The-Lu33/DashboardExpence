...
export default function LoginForm() {
  ...
  return (
    <View className="w-full">
      ...
      <Text className="text-[#999999] mt-3 mb-8">Forgot Password?</Text>
      <View className="flex flex-col justify-between h-40">
        <TouchableOpacity onPress={handleLogin}>
          <View className="w-[90%] flex justify-center items-center mt-5 h-16 mx-auto rounded-xl bg-[#5B37B7]">
